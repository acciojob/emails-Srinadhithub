...
public class Gmail extends Email {
    ...
    private List<Mail> inboxList = new ArrayList<>();
    ...
    public void receiveMail(Date date, String sender, String message){
        ...
        if(inboxList.size()==inboxCapacity){
            Mail removedMail= inboxList.get(0);
            inboxList.remove(0);
            TrashList.add(removedMail);
        }
        inboxList.add(mail);
    }
    ...
    public void deleteMail(String message){
        ...
        List<Mail> inboxList2=new ArrayList<>(inboxList);
        for (Mail mail:inboxList2){
    ...
    public String findLatestMessage(){
        ...
        if(inboxList.size()==0) return null;
